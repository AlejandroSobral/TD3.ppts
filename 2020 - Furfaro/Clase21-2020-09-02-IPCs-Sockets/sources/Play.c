...
int main(int argc, char * argv[])
{
	...
	/*Abrimos el archivo de audio. Si no existe lo creamos. Y si existe lo truncamos*/
...
/*La siguiente función bloquea al proceso hasta que se llene el buffer.*/
		status = read(rawfd, buf, buffsize); /* lee */
...
/* Write generalmente no bloquea hasta que termina. Sino que envía la información presente en el buffer al kernel.*/
